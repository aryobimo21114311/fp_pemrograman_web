...
export default function page() {
  return (
    <div className='bg-white w-[100vw] h-[100vh] flex justify-center items-center'>
      <div className="card bg-[#E3F4F4] shadow-2xl shadow-[#E3F4F4] w-[420px] h-[495px] rounded-[53px]">
        <div className="card-body flex flex-col items-center">
          ...
          <div className='flex flex-col items-center'>
            <button className="btn rounded-full border-[0.3px] border-slate-400 bg-transparent w-32 h-8 mb-5 hover:bg-white">Masuk</button>
